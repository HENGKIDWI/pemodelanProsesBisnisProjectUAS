...
<head>
    ...
    <title>Dashboard Mahasiswa - Lab Terpadu</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <h1 class="text-xl font-bold text-blue-600">Laboratorium Terpadu</h1>
                </div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @elseif($hasActiveDebt)
                        <div class="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                            ...
                            <p class="text-red-700 mt-2">Sistem mendeteksi adanya tanggungan alat yang belum lunas (Lihat tabel di bawah).</p>
                    ...
                    @else
                        <div class="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                            ...
                            <p class="text-green-700 mt-2">Anda tidak memiliki tanggungan alat.</p>
                                ...
                                <tbody>
                                    @foreach($tanggungan as $item)
                                        <tr class="bg-white border-b hover:bg-gray-50">
                                            <td class="px-6 py-4 font-medium text-gray-900">{{ $item->nama_alat }}</td>
                                            <td class="px-6 py-4">{{ $item->deskripsi_denda ?? '-' }}</td>
                                            <td class="px-6 py-4">Rp {{ number_format($item->nominal_denda, 0, ',', '.') }}</td>
                                            <td class="px-6 py-4">
                                                @if($item->is_paid)
