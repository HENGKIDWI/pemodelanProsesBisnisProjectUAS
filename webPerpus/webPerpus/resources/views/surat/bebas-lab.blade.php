...
<html>
<head>
    <title>Surat Bebas Perpustakaan</title>
    <style>
...
<body>
    <div class="header">
        ...
        <h3>PERPUSTAKAAN UTM</h3>
        <small>Jl. Raya Telang, Kamal, Bangkalan - Jawa Timur</small>
    </div>

    <div class="content">
        <h3 style="text-align: center; text-decoration: underline;">SURAT KETERANGAN BEBAS PERPUSTAKAAN</h3>
        <p style="text-align: center;">Nomor: {{ date('Y') }}/PERPUS/SK/{{ str_pad($user->id, 4, '0', STR_PAD_LEFT) }}</p>

        <p>Kepala Perpustakaan Universitas Trunojoyo Madura menerangkan bahwa:</p>
        ...
        <p align="justify">Mahasiswa tersebut di atas telah menyelesaikan segala administrasi peminjaman dan dinyatakan <strong>TIDAK MEMILIKI TANGGUNGAN</strong> di Perpustakaan.</p>
        ...
        <div class="ttd">
            ...
            <p><strong style="text-decoration: underline;">( XXXXXXXXXXXXXXXX )</strong></p>
            <p>NIP. 0000000000000</p>
        </div>
